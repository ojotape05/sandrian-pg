                    ...
                    <div class="col-md-6">
                        ...
                        <form action= "<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                            <div class="card px-5 py-5" id="form1">
                                <div class="form-data">
                                    <div class="forms-inputs mb-4"> <span>Login</span> <input name="login" autocomplete="off" type="text" required>
                                    </div>
                                    <div class="forms-inputs mb-4"> <span>Senha</span> <input name="senha"autocomplete="off" type="password" required>
                                    </div>
