...
<html>
    ...
    <body>
                ...
                if($_SESSION['logado']):
                    if($admin == 1):
                            ...
                            <div id='content' style='margin-top: 20px;'>
                                ...
                                $result = pg_query($connect,'SELECT * FROM `operacao` WHERE concluida = 0');
                                if(pg_num_rows($result) > 0):
                                    $resultado  = pg_query($connect,"CALL getFacasEmProcessamentoUsuario('$codigo_faca','$codigo_usuario')");
        ...
        <?php
        require("../requires/conexao.php");
        $result = pg_query($connect,"SELECT link FROM divulgacao");
        ...
        <?php
            ...
            if(isset($_GET['edita_link'])):
                ...
                pg_query($connect,"UPDATE divulgacao SET link = '$link_divulgacao_mudar'");
